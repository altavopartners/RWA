...
export class SessionService {
   ...
   */
  static async findByToken(token: string): Promise<AuthSession | null> {
    try {
   ...
   */
  static async findByRefreshToken(refreshToken: string): Promise<AuthSession | null> {
    try {
   ...
   */
  static async invalidateSession(sessionId: string): Promise<AuthSession> {
    try {
      return await prisma.authSession.update({
        where: { id: sessionId },
        data: { 
   ...
   */
  static async getUserActiveSessions(userId: string): Promise<AuthSession[]> {
    try {
