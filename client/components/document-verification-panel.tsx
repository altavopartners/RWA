...
import type { BankDocument as Document } from "@/types/bank";
...
function DocumentVerificationDialog({
  ...
  const documentUrl = document.cid
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Review and verify submitted trade documents
          </CardDescription>
        </CardHeader>
        <CardContent>
          {documents.length === 0 ? (
                    ...
                    {document.status === "PENDING" && (
                      <DocumentVerificationDialog
                        ...
                        onVerify={(status, reason) =>
                          handleVerifyDocument(document.id, status, reason)
                        }
                      />
                    )}
                  </div>
