...
function CartContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 via-white to-gray-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 -mt-16">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-[#486C7A] via-[#265663] to-[#0C171B] pt-20 pb-32 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center pt-32">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 text-white leading-tight" style={{ color: '#edf6f9' }}>
            Your Cart
          </h1>
