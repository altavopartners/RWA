      ...
      <div className="relative flex items-center justify-between p-4 border-b border-gray-200/50 dark:border-gray-800/50">
        {!collapsed && (
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold bg-gradient-to-r from-[#5BA8B8] to-[#88CEDC] bg-clip-text text-transparent">
                Hex-Port Bank
              </h2>
        ...
        <Button
          ...
          className={cn(
            ...
            collapsed &&
              "absolute -right-3 top-4 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl border border-gray-200/50 dark:border-gray-800/50 shadow-lg rounded-full z-10"
          )}
        >
          {collapsed ? (
